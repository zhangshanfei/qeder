...
;~function(bt){
	...
	bt.URL = {
		root: "http://www.qedertek.com",
		getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			return "http://www.qedertek.com";
		},
		getConcern: function(){
...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="../dqe/img/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	onlyH.prototype = {
		...
		,getScreenOption: function(){
			return {
				id: "bt-h-scrren"
				,html: "<table><tr><td><img class='bt-h-screen-img' src='../dqe/img/bt-play-h-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		,getScreenOption: function(){
			return {
				id: "bt-v-scrren"
				,html: "<table><tr><td><img class='bt-v-screen-img' src='../dqe/img/bt-play-v-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
...
;~function(bt){
	...
	function tip(){
		var a = bt.advertisement({
			id: id
			,html: "<img class='bt-play-share-tip-img' src='../dqe/img/bt-play-share-tip.png' />"
			,time: 0
		});
		a.show();
