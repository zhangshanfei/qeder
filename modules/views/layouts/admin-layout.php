...
<?php $this->beginBody(); ?>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="<?php echo yii\helpers\Url::to(['/admin']); ?>" style="font-weight:700;font-family:Microsoft Yahei">Qedertek - 后台管理</a>
                ...
                <li class="notification-dropdown hidden-phone">
                    ...
                    <div class="pop-dialog">
                        ...
                        <div class="body">
                            ...
                            <div class="messages">
                                <a href="#" class="item">
                                    <img src="<?php echo \Yii::$app->homeUrl?>admin/img/contact-img.png" class="display" />
                                ...
                                <a href="#" class="item">
                                    <img src="<?php echo \Yii::$app->homeUrl?>admin/img/contact-img2.png" class="display" />
                                    <div class="name">Alejandra Galván</div>
                                    <div class="msg">
        ...
        <ul id="dashboard-menu">
	     ...
	     <li>
            ...
            <li>
                ...
                <li><a href="<?php echo yii\helpers\Url::to(['rbac/roles']); ?>">角色角色</a></li>
                </ul>
            </li>
	     <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                <li><a href="<?php echo yii\helpers\Url::to(['setting/index']); ?>">网站设置</a></li>
                </ul>
            </li>
