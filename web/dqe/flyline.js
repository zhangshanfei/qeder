...
Main.flyLine = function(angle){
	...
	function addLongTrace(xPass, dif, timeC){
		longTracer = new createjs.Bitmap(Resource.get("../dqe/img/longtraces.png"));
	...
	function addTrace(dif){
		var totalD = 0;
		var tracer = new createjs.Bitmap(Resource.get("../dqe/img/traces.png"));
