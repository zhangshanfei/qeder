...
;~function(res){
	...
	res.load = function(){
		...
		res.queue.loadFile("../dqe/img/start.png");
		// res.queue.loadFile("../dqe/img/facelogo.png");
		res.queue.loadFile("../dqe/img/startbtn.png");
		
		res.queue.loadFile("../dqe/img/penguin.png");
		res.queue.loadFile("../dqe/img/bear.png");
		res.queue.loadFile("../dqe/img/hill.png");
		res.queue.loadFile("../dqe/img/guide.png");
		res.queue.loadFile("../dqe/img/background1.png");
		res.queue.loadFile("../dqe/img/background2.png");
		res.queue.loadFile("../dqe/img/flyend.png");
		res.queue.loadFile("../dqe/img/traces.png");
		res.queue.loadFile("../dqe/img/longtraces.png");
		res.queue.loadFile("../dqe/img/score.png");
		res.queue.loadFile("../dqe/img/fly.png");
		
		res.queue.loadFile("../dqe/img/end.png");
		res.queue.loadFile("../dqe/img/againbtn.png");
//		res.queue.loadFile("../dqe/img/notifybtn.png");
	}
...
Main.startGame = function(){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../dqe/img/start.png")));
	
	
	// 开始游戏
	var beginGame = new createjs.Bitmap(Resource.get("../dqe/img/startbtn.png"));
	beginGame.setTransform(190, 580);
	...
	// // 更多游戏 改为分享到Facebook 张善飞2017年10月27日19:08:08
	var moreGame = new createjs.Bitmap(Resource.get("../dqe/img/facelogo.png"));
...
Main.endGame = function(distance){
	...
	container.addChild(new createjs.Bitmap(Resource.get("../dqe/img/end.png")));
	...
	// 再来一次
	var again = new createjs.Bitmap(Resource.get("../dqe/img/againbtn.png"));
	again.setTransform(190, 623);
	...
	// 通知好友
	var notify = new createjs.Bitmap(Resource.get("../dqe/img/notifybtn.png"));
...
Main.initGame = function(){
	...
	var b1 = new createjs.Bitmap(Resource.get("../dqe/img/background2.png"));
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../dqe/img/background2.png"));
	b1.x = Main.width;
	img.addChild(b1);
	b1 = new createjs.Bitmap(Resource.get("../dqe/img/background1.png"));
	b1.x = Main.width * 2;
	img.addChild(b1);
	...
	Main.log("初始化：北极熊");
	var bearImg = new createjs.Bitmap(Resource.get("../dqe/img/bear.png"));
	...
	var bearSS = new createjs.SpriteSheet({
		...
		"images": [Resource.get("../dqe/img/bear.png")],
		"frames":{
			"height": 360,
			"width":300,
			"regX": 0,
	...
	// 路标
	Main.log("初始化:路标");
	var guideBackground = new createjs.Bitmap(Resource.get("../dqe/img/guide.png"));
	...
	Main.log("初始化：企鹅");
	var penguinImg = new createjs.Bitmap(Resource.get("../dqe/img/penguin.png"));
	...
	var penguinSS = new createjs.SpriteSheet({
		...
		,"images" : [Resource.get("../dqe/img/penguin.png")]
		,"frames" : {
			width: 180,
			height: 170,
			count: 6
	...
	var endData = {
		images: [Resource.get("../dqe/img/flyend.png")],
	...
	Main.gameOverScoreBg = new createjs.Bitmap(Resource.get("../dqe/img/score.png"));
...
//	Main.endGame(score);
	setTimeout(function(){
		...
		if(hasNewMaxScore && score > 700){
			btGame.playScoreMsg("You Get your new score,share with your friends on facebook or twitter.");
//			btGame.setShare({
//				title: "我在《打企鹅》中将企鹅打出了"+Main.maxScore+"米，简直停不下来！"
//			});
		}
	}, 1200);
	// console.log(score);	张善飞在此获取本次得分
	postdata();
});
